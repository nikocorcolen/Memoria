...
\begin{figure}[htb]
	...
	\begin{center}
		\includegraphics[bb=0 0 640 480, width=6cm]{permeabilidad.PNG}
	\end{center}
\end{figure}
...
En la Figura 2, se puede apreciar la arquitectura de un servicio web, se ve que el cliente realiza un petición al servidor y éste le envía una respuesta con lo solicitado.


\begin{figure}[htb]
\caption{Arquitectura servicio web}
\centering
\includegraphics[bb=0 0 640 480, width=5cm]{rest.jpg}
\end{figure}
...
Los datas obtenidos se pueden apreciar en la Figura 3:

\begin{figure}[ht!]
\caption{Respuesta del servicio wunderground al hacer una consulta}
\centering
\includegraphics[bb=0 0 640 480, width=10cm]{response.png}
\end{figure}
...
\centering
\includegraphics[bb=0 0 640 480, width=5cm]{rasp.png}
\end{figure}
...
\centering
\includegraphics[bb=0 0 640 480, width=5cm]{sensorHumedad.jpg}
\end{figure}
...
\centering
\includegraphics[bb=0 0 640 480, width=5cm]{valvulasolenoide.jpg}
\end{figure}
...
\centering
\includegraphics[bb=0 0 640 480, width=5cm]{gps.jpg}
\end{figure}
...
\caption{Módem 3G}
\centering
\includegraphics[bb=0 0 640 480, width=4cm]{modem.jpg}
\end{figure}
...
\caption{Cargador}
\centering
\includegraphics[bb=0 0 640 480, width=4cm]{cargador.jpg}
\end{figure}
...
\centering
\includegraphics[bb=0 0 640 480, width=7cm]{gpio.jpg}
\end{figure}
...
\caption{Pines GPIO}
\centering
\includegraphics[bb=0 0 640 480, width=7cm]{giop1.png}
\end{figure}
...
\includegraphics[bb=0 0 640 480, scale=.5]{sistema.png}
\end{figure}
