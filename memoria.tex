...
El proyecto consiste en desarrollar un sistema de riego autónomo e inteligente ideal para el uso en áreas verdes que utilizan sistemas de riego como puede por aspersión. Lo que se busca es reducir la intervención humana, aumentar la eficiencia en el uso del agua, ahorrar dinero y entregar datos estadísticos a los usuarios.
...
Por último la falta de tecnologías innovadores y baratas aplicadas al riego para el uso domestico. Chile es un país con mucha agricultura de debe tener las tecnologías que ayuden a la producción y a la vez sean amigables con el medio ambiente.
