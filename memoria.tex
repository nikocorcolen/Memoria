...
Este capítulo habla acerca de los conceptos necesarios para introducirse en el problema, explicando acerca de la programación de los sistemas de riego y mencionando los trabajos relacionados que existen en la actualidad. También se describen los componentes que serán utilizados para la realización de este trabajo.
...
El presente capítulo tiene por objetivo dar a conocer la forma global del funcionamiento del sistema,  mencionando también la manera en que abordará el problema para llegar a la solución.
...
\centering
\includegraphics[width=16cm]{sistema}
\end{figure}
...
El funcionamiento a grandes rasgos del sistema consiste en...
