...
\item Se ajustará automáticamente a el clima.
\item Consume la menor cantidad de agua posible.
...
La base de datos tiene tiene dos tablas que almacenan la información que es enviada desde la Raspberry Pi. Una tabla de registros con columnas de ``humedad'', ``caudal'' y ``fecha''. La segunda tabla que es donde se almacena el tipo de suelo tiene las columnas ``latitud'', ``longitud'' y ``tipo\_suelo''.
