...
\begin{figure}[ht!]
  ...
  \centering
  \includegraphics[bb=0 0 640 480, width=7cm]{permeabilidad.png}
\end{figure}
...
\centering
\includegraphics[bb=0 0 640 480, width=7cm]{rest.jpg}
\end{figure}
...
El presente capítulo tiene por objetivo dar a conocer la forma global del funcionamiento del sistema.
